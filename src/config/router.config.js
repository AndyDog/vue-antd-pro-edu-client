...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: 'menu.intro', keepAlive: true, permission: ['form'] },
      },
      {
        path: '/course',
        name: 'course',
        ...
        children: [
          {
            ...
            meta: { title: 'menu.coursehome', keepAlive: true, permission: ['form'], parentPath: '/course' },
          },
          {
            ...
            meta: { title: 'menu.courseDetail', keepAlive: true, permission: ['form'], parentPath: '/course' },
          },
        ],
      },
      // {
      ...
      // },
      {
        ...
        component: () => import('@/views/form/stepForm/trainingHome'),
        meta: { title: 'menu.training', keepAlive: true, permission: ['form'] },
        children: [
          {
            path: 'home',
            name: 'trainingHome',
            ...
            meta: { title: 'menu.trainingHome', keepAlive: true, permission: ['form'], parentPath: '/training' },
          },
          {
            path: 'politicsSeminar/:id',
            name: 'politicsSeminar',
            hidden: true,
            component: () => import('@/views/form/stepForm/politicsSeminar'),
            meta: { title: 'menu.politicsSeminar', keepAlive: true, permission: ['form'], parentPath: '/training' },
          },
        ],
      },
        ...
        children: [
          {
            ...
            name: 'showworkHome',
            hidden: true,
            component: () => import('@/views/list/showwork'),
          ...
          },
          {
            ...
            meta: { title: 'menu.showworkDetail', keepAlive: true, permission: ['form'], parentPath: '/showwork' },
          },
        ],
      },
...

      {
        ...
        name: 'trainingDetail',
        hidden: true,
        component: () => import('@/views/form/trainingDetail'),
...
export const constantRouterMap = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'logintemp',
        name: 'logintemp',
        component: () => import(/* webpackChunkName: "user" */ '@/views/user/Logintemp'),
      },
      {
        path: 'register',
        name: 'register',
