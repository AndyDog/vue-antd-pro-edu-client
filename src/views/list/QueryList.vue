    ...
    <a-card :bordered="false">
      <a-tabs v-model="activeKey">
        <a-tab-pane key="1" tab="全部">
          <div>
            <img src="http://106.14.124.163:8090/api/system/sysStaticPicture/trainingProgram" alt="" />

            <a-row>
              <a-col :span="12">学习进度：0%</a-col>
              <a-col :span="12">考试成绩：未考试</a-col>
            </a-row>

            <a-row>
              <a-col :span="12">学习成绩：0分</a-col>
              <a-col :span="12">总成绩：未计算</a-col>
            </a-row>
            <a-row>
              <a-col :span="12"> <a-button>成绩详情</a-button></a-col>
              <a-col :span="12"> <a-button>开始学习</a-button></a-col>
            </a-row>
          </div>
        </a-tab-pane>
        <a-tab-pane key="2" tab="课程信息分类" force-render>Content of Tab Pane 2</a-tab-pane>
      </a-tabs></a-card
    >
      ...
      <a-row :gutter="16">
        <a-col class="gutter-row" v-for="item in projects" :span="6">
          ...
          <div data-v-373a1af0="" class="">
            <img data-v-373a1af0="" :src="item.avatar"
            alt="" class="expert-img">
          </div>
          <div data-v-373a1af0="" class="">
